...
export default defineMessages({
  ...
  doesNotExist: {
    id: "404.galaxy.page.nonexistent",
    defaultMessage: "Oops! The page you clicked does not exist!",
  },
  exploreMessage: {
    id: "404.galaxy.page.message.explore",
    defaultMessage: "Check out the { existing } here.",
  },
  existingLink: {
    id: "404.galaxy.page.link.existing",
    defaultMessage: "existing (Mapathon and User Group Report) pages",
  },
  homeButton: {
    id: "404.galaxy.page.home.button",
