...
export function TrackingBanner() {
  ...
  return (
    <div className={`fixed bottom-0 left-0 text-base w-full text-center pl-2 pr-2 pb-2 pt-3 text-white bg-blue-dark z-10 scale-100 ${display}`}>
      <div id="optout-contents">
        ...
        <p>
          <FormattedMessage {...messages.trackingBannerText} values={{ link: privacyPolicyLink }} />
        </p>
        <div>
          <Button 
            onClick={onAgree} 
